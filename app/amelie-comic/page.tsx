      ...
      {comicPanels.length > 0 && (
        ...
        <form 
          ...
          onSubmit={async (e) => {
            ...
            try {
              const response = await fetch('/api/generate-amelie-comic', {
                method: 'POST',
                headers: {
        ...
        >
          <div className="flex flex-col gap-4">
            <textarea
              ...
              placeholder="Describe your comic story Amelie... (Press Enter to submit)"
              required
              disabled={loading}
        ...
        <div className="w-4/5 mx-auto">
            ...
            <History type="COMIC AMELIE: " limit={limit}/>
        </div>
